    ...
    info (val) {
      if (val) {
        ...
        if (selectPhone.includes('+1')) {
          this.form.select = '+1'
          this.form.agentPhone = selectPhone.replace('+1', '')
        } else if (selectPhone.includes('+852')) {
          this.form.select = '+852'
          this.form.agentPhone = selectPhone.replace('+852', '')
        } else if (selectPhone.includes('+91')) {
          this.form.select = '+91'
          this.form.agentPhone = selectPhone.replace('+91', '')
        } else if (selectPhone.includes('+81')) {
          this.form.select = '+81'
          this.form.agentPhone = selectPhone.replace('+81', '')
        } else {
          this.form.select = ''
          this.form.agentPhone = selectPhone
        }
      }
    }
  },
