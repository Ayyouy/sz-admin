    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        <div class="explain red">
          ...
          <p>
            2、请在系统上线前确认产品需求，如需关闭某个产品显示配置，请确认该产品所有用户的持仓和资金都已清空。关闭产品配置状态，系统不会修改用户的资金和持仓！</p>
          <p>3、该配置只针对实盘用户，模拟用户可以看到所有产品。</p>
        </div>
        <el-form :inline="true" class="demo-form-inline" size="small" ref="logoForm">
          <div class="title">
            A股
            <span class="sub-tit">状态为开启即表示用户可以进行该产品的交易</span>
          </div>
          <el-row>
            <el-col :span="8">
          ...
          <div class="title">
            用户实名认证
            <span class="sub-tit">状态为开启即表示用户实名认证后可以进行交易，关闭则不需要实名认证就可以正常交易</span>
          </div>
          <el-row>
            <el-col :span="8">
          ...
          <div class="title">
            分仓配资
            <span class="sub-tit">状态为开启即表示分仓配资板块全部可用，关闭则不需要分仓配资</span>
          </div>
          <el-row>
            <el-col :span="8">
