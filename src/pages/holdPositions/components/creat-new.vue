      ...
      <el-form :inline="true" :rules="rule" :model="form" class="demo-form-inline" size="small" ref="form">
        <el-row>
          <el-form-item label="选择用户：" prop="userId">
            <el-input style="width:220px;" placeholder="输入用户id查询用户信息" v-model="form.userId"
        ...
        <el-row class="info-box">
          ...
          <el-col :span="6">
            ...
            <span class="value"> {{ userInfo.agentName }} </span>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            ...
            <span class="number">{{ userInfo.userAmt }}</span>
          </el-col>
          <el-col :span="6">
            <span class="title">可用资金：</span>
            <span class="number">{{ userInfo.enableAmt }}</span>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="杠杆倍数：" prop="lever">
              <el-input style="width:220px;" class="form-input" v-model="form.lever"
                        placeholder="输入买入杠杆倍数"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="买入数量：" prop="number">
              <el-input style="width:220px;" placeholder="请输入买入数量" v-model="form.number"
                        class="input-with-select">
          ...
          <el-col :span="12">
            <el-form-item label="封锁天数：" prop="days">
              <el-input style="width:220px;" placeholder="请输入封锁天数" v-model="form.days" type="number"
  ...
  data() {
    return {
      ...
      rule: {
        ...
        days: [
          {required: true, message: '请输入封锁天数', trigger: 'blur'},
