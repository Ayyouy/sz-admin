      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <p>
              <span
                :class="scope.row.stockPlate == '科创'?'kc-mark':'kc-mark a-mark'">{{
                  scope.row.stockPlate == '科创' ? '科创' : 'A股'
                }}</span>
            </p>
            <p>
              {{ scope.row.stockName }}
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              <p :class="changeTextClass[scope.$index] == true?'heartBeat':''">
                ...
                <span v-else
                      :class="scope.row.profitAndLose<0?'green bounceIn':'red bounceIn'">{{
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              <p :class="changeTextClass[scope.$index] == true?'heartBeat':''">
                <span v-if="scope.row.now_price == 0">-</span>
                <span v-else
                      :class="scope.row.allProfitAndLose<0?'green bounceIn':'red bounceIn'">{{
        ...
        <el-table-column
          ...
          label="操作">
          <template slot-scope="scope">
            <el-button v-if="scope.row.isLock == 0" type="primary" plain size="small"
