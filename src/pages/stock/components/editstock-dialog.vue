        ...
        <el-form :inline="true" :model="form" ref="ruleForm" size="mini" label-width="150px" :rules="rule">
          <el-form-item label="国家" prop="countryId">
            <el-select v-model="form.countryId" placeholder="国家">
              <el-option v-for="i in countryIdList" :key="i.key" :label="i.type" :value="i.value"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="锁仓天数" prop="lockTime">
            <el-input v-model="form.lockTime" placeholder="锁仓天数（日）" type="number"></el-input>
          </el-form-item>
          <el-form-item label="折扣率" prop="discount">
            <el-input v-model="form.discount" placeholder="折扣率" type="number"></el-input>
          </el-form-item>
          <el-form-item label="总额度" prop="totalLimit">
            <el-input v-model="form.totalLimit" placeholder="总额度" type="number"></el-input>
          </el-form-item>
  ...
  watch: {
    info (val) {
      if (val) {
        ...
        this.form.stockCode = this.info.stockCode
        this.form.isLock = '' + this.info.isLock
        this.form.isShow = '' + this.info.isShow
        this.form.lockTime = this.info.lockTime / (60 * 24)
        this.form.discount = (this.info.discount * 100).toFixed(0)
        this.form.totalLimit = this.info.totalLimit
        this.form.countryId = '' + this.info.countryId
      ...
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          let opts = {
            ...
            lockTime: this.form.lockTime * 60 * 24,
