  ...
  <div>
    <el-card class="box-card">
      <el-form :inline="true" :model="form" class="demo-form-inline" size="small">
        <el-row>
          <el-radio-group v-model="form.countryId" @change="onSubmit">
      ...
      <div class="table">
        ...
        <el-table
          ...
          <el-table-column
            ...
            label="折扣">
            <template slot-scope="scope">
              <p>{{   (scope.row.discount * 100).toFixed(0) }}%
              </p>
            </template>
          </el-table-column>
          <!-- <el-table-column
  ...
  methods: {
    ...
    async getList () {
      ...
      if(this.form.countryId){
        if(this.form.countryId == '香港'){
          countryId = 1;
        }else if(this.form.countryId == '美国'){
          countryId = 2;
        }else if(this.form.countryId == '日本'){
          countryId = 3;
        }else if(this.form.countryId == '印度'){
          countryId = 4;
        }else if(this.form.countryId == '全部'){
          countryId = '';
        }
      }
