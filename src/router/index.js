      ...
      children: [
        {
          path: 'fund',
          meta: {title: '基金列表'},
          component: _import('money/funds-index')
        },
        {
          path: 'positions',
          meta: {title: '持仓列表'},
          component: _import('money/positions-index')
        },
        {
          path: 'ransoms',
          meta: {title: '赎回列表'},
          component: _import('money/ransoms-index')
        },
        {
          path: 'financial',
          meta: {title: '资金明细'},
          component: _import('money/financial-index')
        },
        {
          path: 'performance',
          meta: {title: '代理业绩统计'},
          component: _import('money/performance-index')
        },
        {
          path: 'earnings',
          meta: {title: '代理收益设置'},
          component: _import('money/earnings-index')
        }
      ]
    }, {
      path: '/statistics',
      ...
      children: [
        {
          ...
          path: 'transfer',
          meta: {title: '转账记录'},
          component: _import('tranfer/components/table')
        }
      ]
    }, {
      path: '/log',
      ...
      children: [
        {
          ...
          path: 'exchangeRate',
          meta: {title: '货币管理'},
          component: _import('exchangeRate/components/table')
        }
      ]
    }, {
      path: '/login',
